(function () {
  ...
  ZoomMtg.preLoadWasm();
  var accRole = document.getElementById("meeting_role").value;

  if(accRole == "1"){
    var API_KEY = document.getElementById("sdk_api_key").value;
    var API_SECRET = document.getElementById("sdk_api_secret").value;
  }else if(accRole == "5"){
    var API_KEY = document.getElementById("sdk_api_key").value;
    var API_SECRET = document.getElementById("sdk_api_secret").value;
  }else{
    var API_KEY = "QXPJHx8_TquaEnPs5Qr5_A";
    var API_SECRET = "pFVkY6HRZ866kmEyM44bERHQWa5d8Fg0nLpB";
  }
  ...
  document
    ...
    .addEventListener("click", function (e) {
      ...
      if (!meetingConfig.mn || !meetingConfig.name) {
        alert("Meeting number or username is empty. Please try again");
        return false;
      }
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          console.log(joinUrl);
          console.log(testTool.serialize(meetingConfig));
          //window.close();
          //window.open(joinUrl, "_blank");
    location.assign(joinUrl);
        },
      });
    });
